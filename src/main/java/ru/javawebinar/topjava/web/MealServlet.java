    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action == null ? "all" : action) {
            ...
            case "allFiltered":
                ...
                LocalDateTime dateStart = LocalDateTime.parse(request.getParameter("dateStart"));
                LocalDateTime dateEnd = LocalDateTime.parse(request.getParameter("dateEnd"));
                request.setAttribute("meals",
                        MealsUtil.getFilteredDateTimeTos(repository.getAll(SecurityUtil.authUserId()), MealsUtil.DEFAULT_CALORIES_PER_DAY, dateStart, dateEnd));
